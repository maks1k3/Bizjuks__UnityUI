...
public class AttelsIzvele : MonoBehaviour
{
    ...
    public void izkritosais(int skaitlis)
    {
        if (skaitlis == 0)
        {
            ...
            tekstsS.text = "Lionels Andress Mesi Kučitīni[a] (spāņu: Lionel Andrés Messi Cuccitini,[2] izrunā: /ljoˈnel anˈdɾes ˈmesi/; dzimis 1987. gada 24. jūnijā), plaši zināms arī kā Leo, ir Argentīnas futbolists, kas spēlē uzbrucēja pozīcijā. Kopš 2023. gada jūlija pārstāv MLS klubu Maiami \"Inter\". Mesi bieži tiek dēvēts par pasaules labāko futbolistu, un nereti arī par visu laiku labāko.[3] Viņš ir ieguvis astoņas Zelta bumbas, un ir vienīgais futbolists vēsturē, kurš to paveicis četrus gadus pēc kārtas, kā arī sešas reizes ieguvis Zelta zābaku.";
        }
        if (skaitlis == 1)
        {
